...
#define CHARACTERISTIC_UUID2 "f40c58cf-64eb-403b-9a9a-fbc263240b43"
...
void setup() {
  ...
  pCharacteristic2->setCallbacks(new CharacteristicsCallBack());
...
class CharacteristicCallBack: public BLECharacteristicCallbacks {
  void onWrite(BLECharacteristic *pChar) override {
    // Get the value from the characteristic as String
